  ...
  $.fn.mauGallery.methods = {
    ...
    prevImage() {
      ...
      $(".item-column").each(function () {
        ...
        if (
          img.length &&
          (activeTag === "all" || img.data("gallery-tag") === activeTag)
        ) {
    ...
    nextImage() {
      ...
      // findindex + clair ++ ? si actimage est nul
      let index = imagesCollection.findIndex(
        (img) => img.attr("src") === activeImage?.attr("src")
      );

      // incrementation + % pour la boucle
    ...
    filterByTag() {
      ...
      //+ active = reapplique active au tag selectionne
